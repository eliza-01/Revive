...
#     {"op": "wait", "zone": "fullscreen", "teleportl": "buffer_init", "timeout_ms": 2000, "thr": 0.87, "retry_count": 5, "retry_delay_ms": 1000, "retry_action": "prev"},
#     {"op": "sleep",     "ms": 900},
...
#   - {"op":"click_in", "zone":"dashboard_body", "teleportl":"<mode_key>", "timeout_ms":2500, "thr":0.88}
#   - {"op":"sleep", "ms":100}
#   - {"op":"click_optional", "zone":"dashboard_body", "teleportl":"buffer_restore_hp", "timeout_ms":1000, "thr":0.87}
#   - {"op": "dashboard_is_locked", "zone": "dashboard_body", "teleportl": "dashboard_is_locked", "timeout_ms": 12000, "thr": 0.80}
