# _archive/servers/l2mad/flows/rows/Rune/PrimevalIsle/Primeval_1.py
FLOW = [
    ...
    # {"op": "sleep", "ms": 1200},
    # # {"op": "click_in", "zone": "fullscreen", "teleportl": "Primeval_1_capt1", "timeout_ms": 2000, "thr": 0.50},
    # {"op":"click_zone_center","zone":"Primeval_1_zone1","delay_ms":300},
    # #фэйлит потому что мы уже сдвинулись
    # # {"op": "wait", "zone": "fullscreen", "teleportl": "Primeval_1_capt1", "timeout_ms": 2000, "thr": 0.87, "retry_count": 3, "retry_delay_ms": 1000, "retry_action": "prev"},
    # {"op": "sleep", "ms": 2000},
    ...
    # {"op": "wait", "zone": "fullscreen", "teleportl": "Varka_1_capt1", "timeout_ms": 2000, "thr": 0.87, "retry_count": 1, "retry_delay_ms": 1000, "retry_action": "prev"},
    # {"op": "sleep", "ms": 1500},
    # {"op": "click_in", "zone": "fullscreen", "teleportl": "Varka_1_capt1", "timeout_ms": 2000, "thr": 0.87},
    # {"op": "sleep", "ms": 900},
    # {"op": "click_in", "zone": "fullscreen", "teleportl": "autofarm", "timeout_ms": 1000, "thr": 0.87},
    # {"op": "sleep", "ms": 500},
    # {"op": "click_in", "zone": "fullscreen", "teleportl": "autofarm", "timeout_ms": 1000, "thr": 0.87},
    ...
    # {"op": "sleep", "ms": 2000},
    # {"op": "wait", "zone": "center_block", "teleportl": "landmark_bridge", "timeout_ms": 6000, "thr": 0.88},
    #     {"op": "send_arduino", "cmd": "pagedown", "delay_ms": 300},  # повернуть
    #     {"op": "sleep", "ms": 2000},
]
