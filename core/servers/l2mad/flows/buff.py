...
# Цикл автобафа для L2MAD. Зонные ключи и template-ключи берутся из zones/buff.py
# =========================
FLOW = [
    ...
    {"op": "wait", "zone": "fullscreen", "tpl": "buffer_init", "timeout_ms": 2000, "thr": 0.87, "retry_count": 11, "retry_delay_ms": 1000, "retry_action": "prev"},
    {"op": "sleep",     "ms": 900},
    {"op": "click_in",  "zone": "fullscreen", "tpl": "{mode_key}",    "timeout_ms": 2500, "thr": 0.88},
    {"op": "sleep",     "ms": 900},
    {"op": "optional_click", "zone": "fullscreen", "tpl": "buffer_restore_hp", "timeout_ms": 2500, "thr": 0.87},
    {"op": "sleep",     "ms": 900},
